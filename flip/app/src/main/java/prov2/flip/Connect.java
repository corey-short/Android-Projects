...
public class Connect extends Activity implements RadioGroup.OnCheckedChangeListener {

    private static final int REQUEST_SELECT_DEVICE = 1;
    private static final int REQUEST_ENABLE_BT = 2;
    private static final int UART_PROFILE_READY = 10;
    public static final String TAG = "BLE connect";
            ...
            public void onClick(View v) {
                if (!mBtAdapter.isEnabled()) {
                    ...
                    if (btnConnectDisconnect.getText().equals("Connect")){
                        ...
                        Intent newIntent = new Intent(Connect.this, DeviceScanActivity.class);
    ...
    public void onBackPressed() {
        if (mState == UART_PROFILE_CONNECTED) {
            ...
            showMessage("flip's running in background.\n Disconnect to exit");
        }
        else {
